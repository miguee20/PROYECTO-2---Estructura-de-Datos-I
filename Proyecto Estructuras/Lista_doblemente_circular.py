...
class ListaCircularDobleWidget(QWidget):
    def __init__(self):
        super().__init__()
        self.lista = []
        self.initUI()
    ...
    def initUI(self):
        self.setWindowTitle('Lista Circular Doblemente Ligada')
        ...
        descripcion_texto = (
            '<h3 style="color:#1E90FF;">LISTA CIRCULAR DOBLE</h3>'
            '<p style="color:white;">'
            'Una lista circular doble es una estructura de datos en la que cada elemento tiene un enlace tanto al siguiente como al anterior, y el último elemento se enlaza de nuevo con el primero, formando así un bucle.'
            '</p>'
            '<p style="color:white;">'
            'Permite insertar y eliminar elementos en el inicio y final de la lista, buscar un valor específico, y rotar la lista a la izquierda o derecha.'
            '</p>'
        )
